    ...
    <table class="data-grid">
      <thead class="data-grid__header"
        ...
        <tr>
          ...
          <th class="data-grid__header-cell">Swarthy</th>
          <th class="data-grid__header-cell">Hotness</th>
          <th class="data-grid__header-cell">Crazy</th>
      ...
      <tbody>
        <tr @dblclick="toggleEditView(relative.id)" v-for="relative in relatives" :key="relative.id"
          ...
          <td class="data-grid__cell">{{ relative.swarthy }}</td>
          <td class="data-grid__cell">{{ relative.hotness }}</td>
          <td class="data-grid__cell">{{ relative.crazy }}</td>
